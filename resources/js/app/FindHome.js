 ...
 * @author Martin Luz
 * @version 1.0
 * Controlador de la seccion buscar casas
 */
; (function(w){
    ...
    function FindHome() {
        ...
        var self         = this;
        var db           = app.getDB();
        var $wrapper     = $('#resultsCasas');
        var $selectOrder = $('#selectOrderCasas'); 
        ...
        self.init = function(o) {
            ...
            $('select#type').find('option[value="Casa"]').attr('selected', 'selected');
        ...
        self.out = function() {
           console.log('Saliendo de seccion casas');
        }
